...
TEST_CASE("Header Count, 8 Headers", "[req][header-count][8-headers]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_HDR_8, sizeof(REQ_HDR_8) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_HDR_8) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_HDR_8, sizeof(REQ_HDR_8) - 1); };
}
...
TEST_CASE("Header Count, 15 Headers", "[req][header-count][15-headers]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_HDR_15, sizeof(REQ_HDR_15) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_HDR_15) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_HDR_15, sizeof(REQ_HDR_15) - 1); };
}
...
TEST_CASE("Header Count, 20 Headers", "[req][header-count][20-headers]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_HDR_20, sizeof(REQ_HDR_20) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_HDR_20) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_HDR_20, sizeof(REQ_HDR_20) - 1); };
}
...
TEST_CASE("Header Count, 28 Headers", "[req][header-count][28-headers]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_HDR_28, sizeof(REQ_HDR_28) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_HDR_28) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_HDR_28, sizeof(REQ_HDR_28) - 1); };
}
...
TEST_CASE("Header Value Length, Short Values", "[req][header-value-length][short-values]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_VAL_SHORT, sizeof(REQ_VAL_SHORT) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_VAL_SHORT) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_VAL_SHORT, sizeof(REQ_VAL_SHORT) - 1); };
}
...
TEST_CASE("Header Value Length, Medium Values", "[req][header-value-length][medium-values]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_VAL_MEDIUM, sizeof(REQ_VAL_MEDIUM) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_VAL_MEDIUM) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_VAL_MEDIUM, sizeof(REQ_VAL_MEDIUM) - 1); };
}
...
TEST_CASE("Header Value Length, Long Values", "[req][header-value-length][long-values]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_VAL_LONG, sizeof(REQ_VAL_LONG) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_VAL_LONG) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_VAL_LONG, sizeof(REQ_VAL_LONG) - 1); };
}
...
TEST_CASE("Header Value Length, Extra Long Values", "[req][header-value-length][extra-long-values]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_VAL_XLONG, sizeof(REQ_VAL_XLONG) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_VAL_XLONG) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_VAL_XLONG, sizeof(REQ_VAL_XLONG) - 1); };
}
...
TEST_CASE("Case Sensitivity, All Lowercase", "[req][case-sensitivity][all-lowercase]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_CASE_LOWER, sizeof(REQ_CASE_LOWER) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_CASE_LOWER) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_CASE_LOWER, sizeof(REQ_CASE_LOWER) - 1); };
}
...
TEST_CASE("Case Sensitivity, Mixed Case", "[req][case-sensitivity][mixed-case]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_CASE_MIXED, sizeof(REQ_CASE_MIXED) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_CASE_MIXED) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_CASE_MIXED, sizeof(REQ_CASE_MIXED) - 1); };
}
...
TEST_CASE("Real-World Requests, Browser", "[req][real-world][browser]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_REAL_BROWSER, sizeof(REQ_REAL_BROWSER) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_REAL_BROWSER) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_REAL_BROWSER, sizeof(REQ_REAL_BROWSER) - 1); };
}
...
TEST_CASE("Real-World Requests, REST API", "[req][real-world][rest-api]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_REAL_API, sizeof(REQ_REAL_API) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_REAL_API) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_REAL_API, sizeof(REQ_REAL_API) - 1); };
}
...
TEST_CASE("Real-World Requests, Mobile App", "[req][real-world][mobile-app]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_REAL_MOBILE, sizeof(REQ_REAL_MOBILE) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_REAL_MOBILE) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_REAL_MOBILE, sizeof(REQ_REAL_MOBILE) - 1); };
}
...
TEST_CASE("Baseline, No Headers", "[req][baseline][no-headers]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_MINIMAL, sizeof(REQ_MINIMAL) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_MINIMAL) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_MINIMAL, sizeof(REQ_MINIMAL) - 1); };
}
...
TEST_CASE("Baseline, Host Only", "[req][baseline][host-only]")
{
    ...
    BENCHMARK(n) { return bench_hwire(REQ_MINIMAL_HOST, sizeof(REQ_MINIMAL_HOST) - 1); };
    snprintf(n, sizeof(n), "%zu B, LC", sizeof(REQ_MINIMAL_HOST) - 1);
    BENCHMARK(n) { return bench_hwire_lc(REQ_MINIMAL_HOST, sizeof(REQ_MINIMAL_HOST) - 1); };
}
