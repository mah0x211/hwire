 ...
 *   A. Browser standard (8): Host, Connection, User-Agent, Accept,
 * Accept-Encoding, Accept-Language, Cache-Control, Upgrade-Insecure-Requests B.
 * Security metadata (7): Sec-CH-UA*, Sec-Fetch-* C. Application/Auth (5):
 * Referer, Cookie, Authorization, X-CSRF-Token, X-Requested-With D.
 * Infrastructure/CDN (8): X-Forwarded-*, Via, CDN-Loop, CF-*
 *
 * Note: All domains use .test TLD (RFC 2606 reserved)
 *       All IPs use TEST-NET ranges (RFC 5737): 192.0.2.0/24, 198.51.100.0/24,
 * 203.0.113.0/24
 */
...
static unsigned char REQ_VAL_SHORT[] = "GET / HTTP/1.1\r\n"
                                       "Host: example.test\r\n"
                                       "Connection: keep-alive\r\n"
...
static unsigned char REQ_VAL_LONG[] =
    ...
    "Sec-Fetch-Dest: document\r\n"
    "Referer: "
    "https://www.example.test/login?redirect=%2Fdashboard%3Ftab%3Dsettings\r\n"
    "Cookie: "
    "session_id=long_session_id_value_abc123def456ghi789jkl012mno345pqr; "
    "user_preferences=lang%3Den%26theme%3Ddark%26timezone%3DAsia%2FTokyo%"
    "26notifications%3Dtrue; "
    "analytics_tracking=_ga=GA1.2.123456789.1234567890; "
    "_fbp=fb.1.1234567890123.1234567890; "
    "cart_data=item1%3D2%26item2%3D1%26item3%3D5\r\n"
    "Authorization: Bearer "
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9."
    "eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiZW1haWwiOiJ1c2VyQGV4YW"
    "1wbGUudGVzdCIsInJvbGUiOiJ1c2VyIn0.long\r\n"
...
static unsigned char REQ_VAL_XLONG[] =
    ...
    "Sec-Fetch-Dest: document\r\n"
    "Referer: "
    "https://www.example.test/products/electronics/computers/laptops/"
    "gaming-laptops/premium-gaming-laptop-model-2024\r\n"
    "Cookie: "
    "session_id=xlong_session_value_with_many_characters_"
    "abc123def456ghi789jkl012mno345pqr678stu901vwx234yz; "
    "user_preferences=lang%3Den%26theme%3Ddark%26timezone%3DAsia%2FTokyo%"
    "26notifications%3Dtrue%26email_opt_in%3Dyes%26personalization%3Denabled; "
    "analytics_first_party=_ga=GA1.1.123456789.1234567890; "
    "analytics_third_party=_ga_ZYXWVUTSRQPONMLKJIHGFEDCBA=GS1.1.1234567890.1.1."
    "1234567890.0.0.0; facebook_pixel=_fbp=fb.1.1234567890123.1234567890123; "
    "google_ads=_gcl_au=1.1.1234567890.1234567890; "
    "shopping_cart=items%3D%5B%7B%22id%22%3A12345%2C%22qty%22%3A2%7D%2C%7B%"
    "22id%22%3A67890%2C%22qty%22%3A1%7D%5D; "
    "recently_viewed=%2Fproducts%2F123%2C%2Fproducts%2F456%2C%2Fproducts%2F789%"
    "2C%2Fproducts%2F012%2C%2Fproducts%2F345\r\n"
    "Authorization: Bearer "
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9."
    "eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiZW1haWwiOiJ1c2VyQGV4YW"
    "1wbGUudGVzdCIsInJvbGUiOiJhZG1pbiIsInBlcm1pc3Npb25zIjpbInJlYWQiLCJ3cml0ZSIs"
    "ImRlbGV0ZSIsImFkbWluIl0sImlhdCI6MTUxNjIzOTAyMiwiaXNzIjoiZXhhbXBsZS50ZXN0Ii"
    "wiYXVkIjoiYXBpLmV4YW1wbGUudGVzdCIsImV4cCI6MTcxNjIzOTAyMiwianRpIjoidW5pcXVl"
    "LWlkLTEyMzQ1Njc4OTAifQ.very_long_signature_here_for_testing_purposes\r\n"
    "X-CSRF-Token: "
    "xlong_csrf_token_with_additional_entropy_and_random_characters_"
    "123456789\r\n"
    "X-Requested-With: XMLHttpRequest\r\n"
...
static unsigned char REQ_CASE_LOWER[] =
    ...
    "cookie: session_id=xyz123abc; _ga=ga1.1.123456789.1234567890\r\n"
    "authorization: bearer "
    "eyjhbgniwinr5ccg6ikpxvcj9."
    "eyjzdwiioiixmjmonty3odkwiiwibmftzsi6ikpvaeguig9lijohn.doe@example.test\r\n"
...
static unsigned char REQ_REAL_BROWSER[] =
    ...
    "Cookie: session_id=user_session_abc123; cart_id=cart_xyz789; "
    "recently_viewed=prod_001,prod_002,prod_003; "
    "_ga=GA1.1.987654321.1700000000; _gid=GA1.2.123456789.1700000000\r\n"
    "Authorization: Bearer "
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.logged_in_user\r\n"
...
static unsigned char REQ_REAL_API[] =
    ...
    "Authorization: Bearer "
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9."
    "eyJzdWIiOiJ1c2VyXzEyMzQ1Iiwic2NvcGUiOiJyZWFkIHdyaXRlIiwiZXhwIjoxNzAwMDAwMD"
    "AwfQ.api_signature\r\n"
...
static unsigned char REQ_MINIMAL[] = "GET / HTTP/1.1\r\n"
                                     "\r\n";

/* HTTP/1.1 minimum with Host (required for compliance) */
static unsigned char REQ_MINIMAL_HOST[] = "GET / HTTP/1.1\r\n"
                                          "Host: example.test\r\n"
                                          "\r\n";
